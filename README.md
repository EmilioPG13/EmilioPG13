...
`Full-Stack Developer · React · Node.js · AI-Powered Apps`
...
## 🤖 AI & Machine Learning
<br>
<img align="left" alt="OpenAI" width="30px" style="padding-right:10px;" src="https://cdn.jsdelivr.net/npm/simple-icons@v13/icons/openai.svg" />
<br clear="left"><br>

Used in **CV Tailor** to rewrite resume bullet points and generate cover letters matched to a specific job description, with automatic tone detection (Professional / Conversational / Enthusiastic).
